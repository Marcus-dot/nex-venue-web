        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Your ticket">
            <div className="flex flex-col items-center text-center gap-5">
                ...
                <div>
                    ...
                    <p className="text-sm font-medium text-surface-dark/50 dark:text-white/50 mt-1">{eventTitle}</p>
                </div>
                {checkedIn ? (
                    ...
                    <p className="text-xs font-medium text-surface-dark/40 dark:text-white/40 max-w-xs">
